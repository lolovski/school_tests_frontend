...
export default function EditCardCategory() {
    ...
    useEffect(() => {
        const fetchCategory = async () => {
            const categoryData = await cardCategoryService.getCardCategory(categoryId);
    ...
    const handleSaveChanges = async () => {
        await cardCategoryService.updateCardCategory(categoryId, { name: categoryName });
        navigate(`/teacher/card_category`);
    };
