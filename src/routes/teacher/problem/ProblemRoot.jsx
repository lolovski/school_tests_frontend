// src/routes/teacher/problem/ProblemRoot.jsx
...
export default function ProblemRoot() {
    ...
    const handleEditProblem = (problemId) => {
        navigate(`/teacher/problem/${problemId}/edit`);
    };

    const handleGoToResults = (problemId) => {
        navigate(`/teacher/problem/${problemId}/results`);
    };
    ...
    return (
        <div className="flex">
            <div className="w-3/4 p-10">
                <HomeButton />
                <h1 className="text-sky-600 text-5xl font-medium pb-10">Управление задачами</h1>
                    ...
                    {filteredProblemsList.map((problem) => (
                        <li key={problem.id} className="border-l-2 border-sky-400 pl-3 py-3 dark:text-white font-medium bg-green-50/5 w-full rounded-lg mb-5">
                            ...
                            <div className="flex space-x-4 mt-5">
                                ...
                                <button
                                    onClick={() => handleGoToResults(problem.id)}
